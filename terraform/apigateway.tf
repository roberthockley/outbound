...
resource "aws_api_gateway_integration_response" "connect_update_post" {
  depends_on  = [aws_api_gateway_integration.connect_outbound_update_post, aws_api_gateway_method_response.connect_outbound_update_post, aws_api_gateway_integration.connect_outbound_update_post, aws_api_gateway_method_response.connect_outbound_update_post, aws_api_gateway_integration.connect_outbound_scan, aws_api_gateway_method_response.connect_outbound_read_post]
  http_method = "POST"
  resource_id = aws_api_gateway_resource.connect_outbound_update.id
  response_parameters = {
    "method.response.header.Access-Control-Allow-Origin" = "'*'"
...
resource "aws_api_gateway_integration_response" "connect_dnd_post" {
  depends_on  = [aws_api_gateway_integration.connect_outbound_dnd_post, aws_api_gateway_method_response.connect_outbound_dnd_post, aws_api_gateway_integration.connect_outbound_scan, aws_api_gateway_method_response.connect_outbound_read_post]
  http_method = "POST"
  resource_id = aws_api_gateway_resource.connect_outbound_dnd.id
  response_parameters = {
    "method.response.header.Access-Control-Allow-Origin" = "'*'"
...
resource "aws_api_gateway_deployment" "connect_outbound_deployment" {
  depends_on  = [aws_api_gateway_integration.connect_outbound_make_post, aws_api_gateway_integration.connect_outbound_make_options, aws_api_gateway_integration.connect_outbound_dnd_post, aws_api_gateway_integration.connect_outbound_dnd_options, aws_api_gateway_integration.connect_outbound_numbers_post, aws_api_gateway_integration.connect_outbound_numbers_options, aws_api_gateway_integration.connect_outbound_update_post, aws_api_gateway_integration.connect_outbound_update_options, aws_api_gateway_integration.connect_outbound_read_options, aws_api_gateway_integration.connect_outbound_scan]
  rest_api_id = aws_api_gateway_rest_api.connect_outbound.id
}
